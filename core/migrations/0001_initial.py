# Generated by Django 5.0 on 2026-02-06 12:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.CharField(choices=[('DESCRIPTION_ONLY', 'Description Only'), ('CODING', 'Coding Task')], default='CODING', max_length=20)),
                ('validation_type', models.CharField(choices=[('MANUAL', 'Manual Grading'), ('AUTO', 'Auto Validation')], default='MANUAL', max_length=10)),
                ('order', models.PositiveIntegerField(default=0)),
                ('assignment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='core.assignment')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_result', models.CharField(choices=[('PENDING', 'Pending'), ('PASS', 'Pass'), ('FAIL', 'Fail'), ('ERROR', 'Runtime Error')], default='PENDING', max_length=10)),
                ('auto_output', models.TextField(blank=True, null=True)),
                ('manual_grade', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_cases', to='core.task')),
            ],
        ),
    ]
